package com.brainitec.loginassignment.sql;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean checkUser(String email) {
         ...
         * Here query function is used to fetch records from user table this function works like we use sql query.
         * SQL query equivalent to this query function is
         * SELECT user_id FROM user WHERE user_email = 'abhay@gmail.com';
         */
        Cursor cursor = db.query(TABLE_USER, //Table to query
                columns,                    //columns to return
    ...
    public boolean checkUser(String userNameOrEmail, String password) {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        // selection criteria
        String selection = COLUMN_USER_NAME + " = ?" + " OR " + COLUMN_USER_EMAIL + " = ?" + " AND " + COLUMN_USER_PASSWORD + " = ?";
